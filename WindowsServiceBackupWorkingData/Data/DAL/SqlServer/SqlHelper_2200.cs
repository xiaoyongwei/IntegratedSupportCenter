...
//namespace DBUtility
//{
//    public class SqlHelper_2200
//    {
//        //数据库连接字符串(web.config来配置)，可以动态更改SQLString支持多数据库.        
//        public static string connectionString = "Data Source=128.1.50.235;Initial Catalog=cimnc;User ID=sa;Password=sa;";

//        public SqlHelper_2200() { }
