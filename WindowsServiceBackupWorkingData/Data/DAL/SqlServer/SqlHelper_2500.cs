...
//namespace DBUtility
//{
//    public class SqlHelper_2500
//    {
//        //数据库连接字符串(web.config来配置)，可以动态更改SQLString支持多数据库.        
//        public static string connectionString = "Data Source=128.1.127.127\\JSDCS;Initial Catalog=test1;User ID=sa;Password=83360009;";

//        public SqlHelper_2500() { }
...
//        public static DataSet Query(string SQLString, string TableName, string TableName1)
//        {
//            using (SqlConnection connection = new SqlConnection(connectionString))
//            {
//                DataSet ds = new DataSet();
