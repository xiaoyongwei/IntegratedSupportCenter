...
public static class MySqlDbHelper
{
    ...
    /// 连接字符串
    /// </summary>
    private static string ConnectionString = "Server=sh-cdb-0fqx23nq.sql.tencentcdb.com;database=[仓库];Port=62897;userid=wan_001;password=w12345678;Character Set=utf8;";
