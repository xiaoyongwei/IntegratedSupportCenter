...
public static class MySqlDbHelper
{
    ...
    /// 连接字符串
    /// </summary>
    private static string ConnectionString = "Server=sh-cdb-0fqx23nq.sql.tencentcdb.com;Port=62897;Database=slbz;userid=wan_001;password=w12345678;Character Set=utf8;";
