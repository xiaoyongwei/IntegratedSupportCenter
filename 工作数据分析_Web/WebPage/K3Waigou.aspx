...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <table class="auto-style7">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="TextBoxGgxh" runat="server" Width="100%"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="auto-style8">辅助属性:</td>
            <td class="auto-style15">
                <asp:TextBox ID="TextBoxFzsx" runat="server" Width="100%"></asp:TextBox>
            </td>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <br />
    <asp:GridView ID="GridView" runat="server" Caption="查询结果"></asp:GridView>
    </asp:Content>
