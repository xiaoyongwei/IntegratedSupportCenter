...
namespace 工作数据分析.Data.DAL.Oracle
{
    ...
    public static class OracleHelper
    {
        ...
        //public static readonly string ConnectionString = "data source=db.21.ej-sh.net/dbms/ejsh;user ID=ejsh;password=kuke.ejsh;";//定义连接数据库的字符串  
        
        public static readonly string ConnectionString = "data source=fadb.21.ej-sh.net:1521/dbms/ferp;user ID=ferp;password=kuke.ferp;";//定义连接数据库的字符串  
