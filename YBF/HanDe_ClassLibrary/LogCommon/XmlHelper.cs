...
namespace HandeJobManager.Common
{
    ...
    public class XmlHelper
    {
        ...
        /// 创建一个带有根节点的Xml文件
        /// </summary>
        /// <param customerName="FileName">Xml文件名称</param>
        /// <param customerName="RootName">根节点名称</param>
        /// <param customerName="Encode">编码方式:gb2312，UTF-8等常见的</param>
        /// <returns>返回真为新建成功，否则失败</returns>
        ...
        /// 插入一个节点和它的若干子节点
        /// </summary>
        /// <param customerName="XmlFile">Xml文件路径</param>
        /// <param customerName="NewNodeName">插入的节点名称</param>
        /// <param customerName="HasAttributes">此节点是否具有属性，True为有，False为无</param>
        /// <param customerName="fatherNode">此插入节点的父节点,要匹配的XPath表达式(例如:"//节点名//子节点名)</param>
        /// <param customerName="htAtt">此节点的属性，Key为属性名，Value为属性值</param>
        /// <param customerName="htSubNode">子节点的属性，Key为Name,Value为InnerText</param>
        ...
        /// </summary>
        /// <param customerName="XmlFile">Xml文件路径</param>
        /// <param customerName="fatherNode">需要更新节点的上级节点,要匹配的XPath表达式(例如:"//节点名//子节点名)</param>
        /// <param customerName="htAtt">需要更新的属性表，Key代表需要更新的属性，Value代表更新后的值</param>
        /// <param customerName="htSubNode">需要更新的子节点的属性表，Key代表需要更新的子节点名字Name,Value代表更新后的值InnerText</param>
        /// <returns>返回真为更新成功，否则失败</returns>
        ...
        /// </summary>
        /// <param customerName="XmlFile">Xml文件路径</param>
        /// <param customerName="fatherNode">制定节点,要匹配的XPath表达式(例如:"//节点名//子节点名)</param>
        /// <returns>返回真为更新成功，否则失败</returns>
        ...
        /// </summary>
        /// <param customerName="xmlFileName">XML文档完全文件名(包含物理路径)</param>
        /// <param customerName="xpath">要匹配的XPath表达式(例如:"//节点名//子节点名</param>
        ...
        /// <param customerName="xmlFileName">XML文档完全文件名(包含物理路径)</param>
        /// <param customerName="xpath">要匹配的XPath表达式(例如:"//节点名//子节点名</param>
        /// <param customerName="xmlAttributeName">要删除的xmlAttributeName的属性名称</param>
        /// <returns>成功返回true,失败返回false</returns>
        ...
        /// 设置节点属性
        /// </summary>
        /// <param customerName="xe">节点所处的Element</param>
        /// <param customerName="htAttribute">节点属性，Key代表属性名称，Value代表属性值</param>
        ...
        /// 增加子节点到根节点下
        /// </summary>
        /// <param customerName="rootNode">上级节点名称</param>
        /// <param customerName="XmlDoc">Xml文档</param>
        /// <param customerName="rootXe">父根节点所属的Element</param>
        /// <param customerName="SubNodes">子节点属性，Key为Name值，Value为InnerText值</param>
        ...
        /// </summary>
        /// <param customerName="root">根节点名字</param>
        /// <param customerName="htAtt">需要更改的属性名称和值</param>
        /// <param customerName="htSubNode">需要更改InnerText的子节点名字和值</param>
        ...
        /// <param customerName="xmlFileName">XML文档完全文件名(包含物理路径)</param>
        /// <param customerName="xpath">要匹配的XPath表达式(例如:"//节点名//子节点名</param>
        /// <param customerName="xmlAttributeName">要匹配xmlAttributeName的属性名称</param>
